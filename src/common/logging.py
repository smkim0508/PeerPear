...
# NOTE: this logging is meant for async tasks in general, but used here because our app will scale to async with FastAPI in the future
...
# import session_id_var and set it before using logging
