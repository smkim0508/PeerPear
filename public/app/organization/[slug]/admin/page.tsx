              ...
              <div className="mb-12">
                <h2 className="text-2xl font-semibold mb-6 flex items-center gap-2">
                  <div className="bg-primary/70 p-2 rounded-full">
                    <CheckCircle className="w-5 h-5 text-pear-3 text-green-600" />
                  </div>
                  Owners
                </h2>
                    ...
                    owners.map((owner) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 bg-primary/70 rounded-full flex items-center justify-center text-green-600 font-bold text-xl">
                            {owner.first_name[0]}
                            {owner.last_name[0]}
                          </div>
                          <div>
