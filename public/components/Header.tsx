    ...
    <header className="bg-nav-dark text-white font-sans">
      <div className="max-w-[1200px] mx-auto px-8 py-3.5 flex items-center justify-between">
        <div className="flex items-center gap-2 cursor-pointer group">
          ...
          />
          <span className="text-lg font-bold tracking-tight transition-colors duration-300 group-hover:text-green">
            PeerPear
          </span>
        </div>
        ...
        <nav className="absolute left-1/2 -translate-x-1/2 flex gap-6 items-center text-[15px] font-medium">
          <a
            href="#"
            className="text-white no-underline relative group transition-colors duration-300 hover:text-green"
          >
            dashboard
