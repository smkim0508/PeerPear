...
export default function Navbar({ onLoginClick, onLogoutClick, userType }: HeaderProps) {
    return (
        <div className="w-full bg-[#C3DD90]">
            <div className="flex items-center justify-between w-screen h-16 px-6">
                        ...
                        <NavigationMenuList className="flex gap-6">
                            {userType === 'student' ?
                                <NavigationMenuItem className="bg-[#C3DD90]">
                                    <NavigationMenuLink asChild className={"!bg-[#C3DD90] " + navigationMenuTriggerStyle()}>
                            ...
                            <NavigationMenuItem>
                                <NavigationMenuLink asChild className={"!bg-[#C3DD90] hover:!bg-[#6f7e51]" + navigationMenuTriggerStyle()}>
                ...
                {userType === 'guest' ?
                    ...
                    <button onClick={onLogoutClick} className="px-4 py-2 rounded hover:bg-opacity-90 transition-colors flex items-center gap-2">
                        logout
                    </button>
