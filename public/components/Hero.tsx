      ...
      <div className="max-w-[1200px] mx-auto px-8 py-20 pb-16">
        <div className="text-center flex flex-col items-center">
          <h1 className="text-[72px] leading-[1.1] m-0 font-extrabold text-[#0a0a0a] tracking-tight">
            Pair <span className="relative inline-block whitespace-nowrap">
              smarter
          ...
          <p className="mt-6 text-[19px] leading-relaxed text-[#1a1a1a] max-w-[720px]">
            PeerPear makes it effortless for student organizations to run mentorships,
            class projects, and big-little programs — all in one centralized platform.
          </p>
